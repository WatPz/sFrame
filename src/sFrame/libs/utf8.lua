...
function utf8.encode(unicode)
	...
	elseif (unicode <= 0xFFFF) then
		...
		return 'x' ..
			string.format('%X', Byte0) .. 'x' .. string.format('%X', Byte1) .. 'x' .. string.format('%X', Byte2)
	elseif (unicode <= 0x10FFFF) then
		...
		return 'x' ..
			string.format('%X', Byte0) ..
				'x' ..
					string.format('%X', Byte1) .. 'x' .. string.format('%X', Byte2) .. 'x' .. string.format('%X', Byte3)
	else
...
function parse(...)
	...
	return _parse(utf8.convert(cmds))
end
